...
function StateDisplayInline({ icon: Icon, title, message, variant = "default" }: StateDisplayProps) {
    const bgClass = variant === "destructive" ? "bg-destructive/10" :
        variant === "primary" ? "bg-primary/10" : "bg-accent";
