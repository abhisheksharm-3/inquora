 ...
 */
export const SiteHeader = ({ current }: { current?: "how" }) => (
    ...
    <div className="flex h-16 items-center justify-between gap-4 px-6 sm:px-7 wide:px-10">
      ...
      <nav className="flex items-center gap-4 sm:gap-6">
        <Link
          ...
          className={`hidden h-9 items-center whitespace-nowrap font-record text-[0.72rem] uppercase tracking-[0.11em] sm:flex ${
        ...
        >
          {/* Two labels, one control. "Start reading" wrapped to two lines
              inside a 390px bar, which is how a primary action stops looking
              like one. */}
